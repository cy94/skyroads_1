...
def performDetect(imagePath="/mnt/image.png", thresh= 0.25, configPath = b"yolov3-traffic.cfg", weightPath = b"/mnt/backup/yolov3-traffic_30000.weights", metaPath= b"traffic_new_2.data", showImage= True, makeImageOnly = False, initOnly= False):
    ...
    if showImage:
        try:
            ...
            if not makeImageOnly:
                print("HOOHOHOOHO")
                io.imsave("predictions.png",image)
                #io.show()
            print("POIHGFYUJHHJNJNHGGBH")
